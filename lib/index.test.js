...
var apiQueries = __importStar(require("../../../../apiDefs/query"));
var rootApiQuery = __importStar(require("../../../../apiDefs/getApiDefinitions"));
var schema_1 = require("../../../../apiDefs/schema");
var constants_1 = require("../../../../types/constants");
var paths_1 = require("../../../../types/constants/paths");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                (0, react_1.render)(react_2.default.createElement(_1.SandboxAccessForm, { apiIdentifier: "", authTypes: [], internalOnly: false, onFailure: mockOnFailure, onSuccess: mockOnSuccess, urls: {
                        acgPkceAuthUrl: paths_1.AUTHORIZATION_PKCE_PATH,
                        ccgPublicKeyUrl: paths_1.AUTHORIZATION_CCG_PATH,
                        postUrl: constants_1.LPB_APPLY_URL,
                        termsOfServiceUrl: paths_1.TERMS_OF_SERVICE_PATH,
                    } }));
                return [2 /*return*/];
        }
    });
}); };
var armageddonResetFakeCategories = __assign(__assign({}, fakeCategories), { movies: __assign(__assign({}, fakeCategories.movies), { apis: [
            fakeCategories.movies.apis[0],
            __assign(__assign({}, fakeCategories.movies.apis[1]), { vaInternalOnly: schema_1.VaInternalOnly.FlagOnly }),
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    jest.spyOn(apiQueries, 'getApisLoadedState').mockReturnValue(constants_1.apiLoadingState.LOADED);
