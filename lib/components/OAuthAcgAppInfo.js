...
var OAuthAcgAppInfo = function (_a) {
    ...
    return (React.createElement("div", { className: "sandbox-access-form-oauth-details" },
        ...
        React.createElement("div", { className: "vads-u-margin-top--4" },
            ...
            "."),
        React.createElement(FieldSet_1.default, { className: "vads-u-margin-top--4", legend: "Can your application securely hide a client secret?", legendClassName: "legend-label", name: "oAuthApplicationType", required: true },
