...
var OAuthAcgAppInfo = function (_a) {
    ...
    return (React.createElement("div", { className: "sandbox-access-form-oauth-details" },
        React.createElement("h3", null, "Authorization Code Flow"),
        React.createElement("div", { className: "vads-u-margin-top--4" },
            ...
            "."),
        React.createElement(FieldSet_1.default, { className: (0, classnames_1.default)('vads-u-margin-top--4', 'vads-u-padding-left--1p5'), legend: "Can your application securely hide a client secret?", legendClassName: "legend-label", name: "oAuthApplicationType", required: true },
        ...
        React.createElement(TextField_1.default, { label: "OAuth Redirect URI", name: "oAuthRedirectURI", placeholder: "http://localhost:8080/oauth/callback", required: true, className: (0, classnames_1.default)('vads-u-margin-top--4', 'oauth-uri-input', 'xsmall-screen:vads-l-col--10') })));
};
