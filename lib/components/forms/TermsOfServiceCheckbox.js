...
var TermsOfServiceCheckbox = function (_a) {
    ...
    return (react_1.default.createElement(CheckboxRadioField_1.default, { label: "I agree to the terms of service.", labelClassOverride: "vads-u-margin-top--0", name: "termsOfService", required: true, type: "checkbox", description: react_1.default.createElement("p", { className: (0, classnames_1.default)({ 'vads-u-font-weight--bold': hasTermsOfServiceError }) },
            "Review our",
            ' ',
