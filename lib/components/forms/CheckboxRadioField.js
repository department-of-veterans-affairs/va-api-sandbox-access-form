...
var CheckboxRadioField = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, classnames_1.default)({
        ...
        react_1.default.createElement(formik_1.Field, __assign({ id: fieldId, name: name, type: type, role: type, value: value, innerRef: innerRef, "aria-invalid": shouldDisplayErrors, "aria-describedby": "".concat(showError ? errorId : '', " ").concat(description ? descriptionId : '') }, props)),
