...
export declare const ApiCategoryContentPropType: PropTypes.Requireable<PropTypes.InferProps<{
    consumerDocsLinkText: PropTypes.Requireable<string>;
    overview: PropTypes.Validator<any>;
    quickstart: PropTypes.Requireable<any>;
    shortDescription: PropTypes.Validator<string>;
    veteranRedirect: PropTypes.Requireable<any>;
}>>;
