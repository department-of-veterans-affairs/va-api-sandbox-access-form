...
var InternalOnlyInfo_1 = require("./components/InternalOnlyInfo");
var initialValues = {
    description: '',
    email: '',
    firstName: '',
...
var SandboxAccessForm = function (_a) {
    ...
    return (react_1.default.createElement(react_router_dom_1.BrowserRouter, null,
        react_1.default.createElement("div", { className: "vads-l-row" },
            react_1.default.createElement("div", { className: "vads-u-padding-x--2p5" },
                react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, onSubmit: handleSubmit, validate: validateForm_1.validateForm, validateOnBlur: false, validateOnChange: false }, function (_a) {
                    ...
                    return (react_1.default.createElement(formik_1.Form, { noValidate: true, onChange: authTypeChange },
                        ...
                        react_1.default.createElement(TextField_1.default, { label: "Email", name: "email", type: "email", required: true, className: "vads-u-margin-top--4" }),
                        authTypes.length > 1 && (react_1.default.createElement(FieldSet_1.default, { className: "vads-u-margin-top--4", legend: "Choose your auth type", name: "typeAndApi", required: true },
                            authTypes.includes('apikey') && (react_1.default.createElement(CheckboxRadioField_1.default, { type: "radio", label: "API Key", name: "authType", value: "apikey/".concat(apiIdentifier), required: true })),
                            authTypes.includes('acg') && (react_1.default.createElement(CheckboxRadioField_1.default, { type: "radio", label: "Authorization Code Flow", name: "typeAndApi", value: "acg/".concat(apiIdentifier), required: true })),
                        ...
                        authType === 'acg' && react_1.default.createElement(OAuthAcgAppInfo_1.OAuthAcgAppInfo, { acgPkceAuthUrl: acgPkceAuthUrl }),
                        authType === 'ccg' && react_1.default.createElement(OAuthCcgAppInfo_1.OAuthCcgAppInfo, { ccgPublicKeyUrl: ccgPublicKeyUrl }),
                        internalOnly && react_1.default.createElement(InternalOnlyInfo_1.InternalOnlyInfo, null),
                        react_1.default.createElement(TextField_1.default, { as: "textarea", label: "Briefly describe how your organization will use VA APIs:", name: "description", className: "vads-u-margin-top--4" }),
