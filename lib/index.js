...
var BenefitsIntakeAttestationModal_1 = require("./components/attestations/BenefitsIntakeAttestationModal");
var initialValues = {
...
var SandboxAccessForm = function (_a) {
    ...
    return (react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, onSubmit: handleSubmit, validate: validateForm_1.validateForm, validateOnBlur: false, validateOnChange: false }, function (_a) {
        ...
        return (react_1.default.createElement(formik_1.Form, { noValidate: true, onChange: authTypeChange },
            ...
            react_1.default.createElement(TextField_1.default, { label: "Organization", name: "organization", required: true, className: "vads-u-margin-top--4" }),
            ...
            react_1.default.createElement(BenefitsIntakeAttestationModal_1.BenefitsIntakeAttestationModal, null),
